      ...
      <div className="container-px mx-auto flex h-20 max-w-7xl items-center justify-between">
        <Link to="/" className="group flex items-center gap-3">
          ...
          <div className="leading-tight">
            <div className="font-display text-xl text-foreground notranslate" translate="no">
              {BUSINESS.name}
            </div>
        ...
        <div className="hidden items-center gap-3 md:flex">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 rounded-full bg-foreground px-5 py-2.5 text-sm font-medium text-background transition-opacity hover:opacity-90 notranslate"
            translate="no"
          >
      ...
      {open && (
        <div className="border-t border-border md:hidden">
          <div className="container-px mx-auto flex max-w-7xl flex-col gap-1 py-4">
            ...
            <a
              href={`tel:${BUSINESS.phoneRaw}`}
              className="mt-2 rounded-md bg-foreground px-3 py-3 text-center text-sm font-medium text-background notranslate"
              translate="no"
            >
              Call {BUSINESS.phone}
            </a>
            <a
              ...
              target="_blank"
              rel="noreferrer noopener"
              className="mt-2 inline-flex items-center justify-center gap-2 rounded-md border border-border px-3 py-3 text-sm font-medium text-foreground notranslate"
              translate="no"
            >
